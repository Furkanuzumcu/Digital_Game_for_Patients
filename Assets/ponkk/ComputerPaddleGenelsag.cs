...
public class ComputerPaddleGenelsag : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.position = new Vector3(-8.66f, -1.74f, 316f); // Paddle'ýn baþlangýç pozisyonu
    ...
    void Update()
    {
        ...
        if (distanceToBall <= followDistance)
        {
            ...
            transform.position = new Vector3(
                ...
                Mathf.Clamp(transform.position.y, -5.83f, 2.22f), // Y eksenindeki sýnýrlarý ayarlayýn
